...
class ResetPassword
{
    ...
    function __construct()
    {
        ...
        try {
            $this->adtools = new adtools\adtools('reset');
        } catch (Exception $e) {
    ...
    function reset_password($user_dn, $voucher)
    {
        ...
        $voucher_file = Vouchers::check_voucher($voucher);
